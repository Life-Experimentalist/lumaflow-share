// MediaMTX WebRTC (WHEP) reader, copied from the stream server
// (bluenviron/mediamtx, MIT licence). Only change: exported as a module
// instead of being set on window.
